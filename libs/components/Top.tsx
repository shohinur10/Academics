	...
	if (device === 'mobile') {
		return (
			<Stack className={'top'}>
				...
				<Link href={'/course'}><div>{t('Courses')}</div></Link>
				<Link href={'/instructor'}><div> {t('Instructors')} </div></Link>
				...
				<Stack className={`navbar-main ${colorChange ? 'transparent' : ''} ${bgColor ? 'transparent' : ''}`}>
					<Stack className={'container'}>
						<div className={'logo-box'}>
							<Link href={'/'}>
								<img src="/img/logo/logoWhite.svg" alt="Academics" />
							</Link>
						</div>
						<div className={'router-box'}>
							...
							<Link href={'/instructor'}><div> {t('Instructors')} </div></Link>
							<Link href={'/community?articleCategory=FREE'}><div> {t('Community')} </div></Link>
							{user?._id && <Link href={'/mypage'}><div> {t('My Learning')} </div></Link>}
							<Link href={'/cs'}><div> {t('Support')} </div></Link>
						</div>
